...
export declare function AvailabilitySettings({ schedule, travelSchedules, handleDelete, isDeleting, isLoading, isSaving, timeFormat, weekStart, backPath, handleSubmit, isPlatform, customClassNames, disableEditableHeading, }: AvailabilitySettingsProps): JSX.Element;
export {};
