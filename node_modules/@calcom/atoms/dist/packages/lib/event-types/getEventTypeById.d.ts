...
export declare const getEventTypeById: ({ currentOrganizationId, eventTypeId, userId, prisma, isTrpcCall, isUserOrganizationAdmin, }: getEventTypeByIdProps) => Promise<{
    eventType: {
