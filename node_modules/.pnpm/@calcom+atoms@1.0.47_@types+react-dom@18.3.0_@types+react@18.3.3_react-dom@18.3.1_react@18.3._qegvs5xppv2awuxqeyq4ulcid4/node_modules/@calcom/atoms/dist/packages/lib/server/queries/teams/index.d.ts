...
export declare function isTeamAdmin(userId: number, teamId: number): Promise<false | ({
    team: {
        metadata: Prisma.JsonValue;
        parentId: number | null;
        isOrganization: boolean;
...
export declare function isTeamOwner(userId: number, teamId: number): Promise<boolean>;
export declare function isTeamMember(userId: number, teamId: number): Promise<boolean>;
export declare function updateNewTeamMemberEventTypes(userId: number, teamId: number): Promise<void>;
