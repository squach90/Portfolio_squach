...
import type { DestinationCalendar, SelectedCalendar, User } from '../prisma/client';
...
export declare function getConnectedDestinationCalendars(user: UserWithCalendars, onboarding: boolean, prisma: PrismaClient): Promise<{
    connectedCalendars: ({
...
//# sourceMappingURL=getConnectedDestinationCalendars.d.ts.map